...
public class OdevProjeApplication {

	public static void main(String[] args) {
		SpringApplication.run(OdevProjeApplication.class, args);
	}
	
	// ÖNEMLİ . . . ! ? 
	// TEKNOLOJİ ADD İŞLEMİ UPDATE GİBİ DAVRANIYOR, VİDEO İÇERİĞİNDE KONUYA KISACA DEĞİNİLİYOR
	// TEKNOLOJİ için byid, update, delete işlemleri yapılacak
	// validation & exception & log işlemleri yapılacak
